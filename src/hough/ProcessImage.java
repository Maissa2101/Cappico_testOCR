...
public class ProcessImage {
    ...
    public BufferedImage formatageIm(BufferedImage im) {
    ...
    public BufferedImage formatageImCircle(BufferedImage im) {
        // on recupere le format ( delimite par une boite englobante ) on la rescale centre et voila
        BufferedImage imchar;
    ...
    public BufferedImage decoupage(BufferedImage im) {
    ...
    public BufferedImage decoupageCircle(BufferedImage im) {
    ...
    public void boiteEnglobante(BufferedImage im) {
        minX = im.getWidth();
        minY = im.getHeight();
    ...
    public void boiteEnglobanteCircle(BufferedImage im) {
        minXC = im.getWidth();
        minYC = im.getHeight();
        for (int i = 0; i < im.getWidth(); i++) {
            for (int j = 0; j < im.getHeight(); j++) {
    ...
    public BufferedImage erosion(BufferedImage im) {
    ...
    public BufferedImage bAndW(BufferedImage im) {
