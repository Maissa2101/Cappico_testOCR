    ...
    public ImagePanel(List<HoughLine> lines, int index) {
        {
            ...
            try {
                im = ImageIO.read(new File(System.getProperty("user.home"),"/ocr/image" + index + ".png"));
                JLabel label = new JLabel(new ImageIcon(System.getProperty("user.home"),"/ocr/image" + index + ".png"));
                this.add(label);
            } catch (IOException e) {
