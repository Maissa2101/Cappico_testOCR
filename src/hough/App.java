...
public class App extends JFrame {
    ...
    BufferedImage loadImage(String nameFile) {
        ...
        try {
            ...
            if (nameFile != null) {
                ...
                im = ImageIO.read(new File(System.getProperty("user.home"),"/ocr/picture/" + nameFile + ".png"));
            } else {
                im = ImageIO.read(new File(System.getProperty("user.home"),"/ocr/picture/.png"));
            }
            return im;
        } catch (IOException e) {
    ...
    public static void save(BufferedImage im, String name) {
        File outputfile;
        if (name != null) {
    ...
    Mat loadImageMat(String name) {
        String file = System.getProperty("user.home")+"/ocr/" + name + ".png";
